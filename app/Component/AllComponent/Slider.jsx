      ...
      <div className=" md:my-6 lg:my-0">
...

        {
          ...
          <div className=" flex  flex-col lg:flex-row md:px-4 lg:px-28 justify-end md:gap-4 w-full mt-3 ">
            ...
            <div className="flex  lg:gap-2  lg:w-3/6 justify-around">



              <div className="rounded-2xl overflow-hidden  w-[300px]  h-[200px] lg:h-[350px] hidden md:block">


                <img src={`${storageLink}/${sliderdata.info[0]?.img2}`} alt="" className="  w-[350px]  h-[200px] lg:h-[300px] " />

              </div>
            
              <div className="rounded-2xl overflow-hidden w-[350px]   h-[200px] lg:h-[300px] hidden md:block">


                <img src={`${storageLink}/${sliderdata.info[0]?.img4}`} alt="" className="w-[350px]  h-[200px] lg:h-[300px] " />
