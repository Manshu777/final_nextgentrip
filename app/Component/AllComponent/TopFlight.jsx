    ...
    },
    {
      ...
      images: [
        ...
        },
        {
          ...
          title: "Mumbai",
          description: t("desb2"),
          link: `/hotels/cityName=Mumbai&citycode=144306&checkin=${
            formattedDate.split("T")[0]
          }&checkout=${
            formattedDate.split("T")[0]
          }&adult=1&child=0&roomes=1&page=0&star=0/`,
        },
        {
          ...
          title: "Shimla",
          description: t("desb3"),
          link: `/hotels/cityName=Shimla&citycode=138673&checkin=${
            formattedDate.split("T")[0]
          }&checkout=${
            formattedDate.split("T")[0]
          }&adult=1&child=0&roomes=1&page=0&star=0/`,
        },
        {
          ...
          title: "Guwahati",
          description: t("desb4"),
          link: `/hotels/cityName=Guwahati&citycode=121139&checkin=${
            formattedDate.split("T")[0]
          }&checkout=${
            formattedDate.split("T")[0]
          }&adult=1&child=0&roomes=1&page=0&star=0/`,
        },
        {
          ...
          title: "Amritsar",
          description: t("desb5"),
          link: `/hotels/cityName=Amritsar&citycode=101129&checkin=${
            formattedDate.split("T")[0]
          }&checkout=${
            formattedDate.split("T")[0]
          }&adult=1&child=0&roomes=1&page=0&star=0/`,
  ...
  return (
    <>
      ...
      <div className="flight pt-0 lg:pt-1 px-0 md:px-10 lg:px-28 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-5 p-3">
          ...
          <div className="bg-white border shadow-md rounded-xl">
            <div className="bg-[#0291d2] text-center py-3 text-white text-lg font-semibold">
              {t("heading1")}
            </div>
            {topport &&
              topport.map((item, i) => (
                <Link
                  key={i}
                  href={`flightto=${item.from_code}&from=${item.to_code}&date=${formattedDate}&prfdate=${formattedDate}&JourneyType=1&adultcount=1&childCount=0&infantCount=0&selectedClass=1/`}
                  className="flex items-center border-b px-6 py-2 hover:bg-gray-50"
                >
                  <img
              ...
              >
                ...
                <div className="px-4 w-full">
                  ...
                  <p className="text-xs text-gray-500">
                    📍 {pkg.city}, {pkg.country} ⏳ {pkg.duration} days
                  </p>
                </div>
              </Link>
            ))}
      ...
      <div className="w-full mx-auto px-6 md:px-10 lg:px-28 pt-0 lg:pt-6">
        <h2 className="text-center text-4xl font-bold text-[#10325a] mb-6">
          Tourist <span className="text-[#45a183]">Love</span>
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
          {attractions.map((attraction, index) => (
            <Link
              ...
              key={index}
              className="border-4 border-[#009dff] shadow-md rounded-lg p-4 bg-white"
            >
