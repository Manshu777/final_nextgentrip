...
const page = () => {
  ...
  const handelcruiseMessage = async (e) => {
    e.preventDefault();
    const res = await axios.post(`${apilink}/charter`, {
      ...alldata,
  ...
  return (
    <>
      <head>
        ...
        <meta
          name="description"
          content="Book private charters with NextGenTrip. Choose from jets, helicopters, and air services for luxury, business, or emergency travel—fast, secure, and flexible."
        />
      </head>
          ...
          <div className=" h-full   w-full flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between relative z-10">
            <div className=" lg:w-1/2 space-y-4 ">
              ...
              <p className="text-white">
                Embark on a journey of a lifetime aboard a luxury charter ,
                where every moment is designed to captivate your senses and
                leave you with unforgettable memories. Perfect for adventurers
                who crave the perfect balance of style, comfort, and excitement,
                this voyage offers more than just a trip — it’s an experience
                like no other. From opulent accommodations and world-class
                dining to exhilarating activities and breathtaking destinations,
                every detail is tailored to create an extraordinary escape.
                Whether you’re exploring hidden gems
              </p>
            </div>
        ...
        <div className="px-5 lg:px-20  space-y-4">
          ...
          <div className="startHere ">
            <div className="text-center xl:w-[70%] mx-auto space-y-5">
              ...
              <p>
                ...
                providing the best options for an unforgettable charter
                adventure.
              </p>
            </div>
          ...
          <section className="details space-y-5 py-10 ">
            <div className="text-center">
              ...
              <p>
                Embark on a charter journey like no other. From tropical islands
                to majestic glaciers, our luxury charters offer something for
